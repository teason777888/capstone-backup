...
def create_questionnaire_question(data):
    ...
    if QuestionnaireQuestionBank.query.filter_by(question_text=question_text).first():
...
def create_questionnaire_survey(data):
...
def get_questionnaire_survey_by_id(survey_id):
